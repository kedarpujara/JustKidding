...
export default function EarningsScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}><Text style={styles.title}>Earnings</Text></View>
      <Screen scrollable><Text style={styles.placeholder}>Earnings dashboard coming soon...</Text></Screen>
    </View>
  );
}
