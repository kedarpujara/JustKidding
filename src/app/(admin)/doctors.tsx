...
export default function AdminDoctors() {
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}><Text style={styles.title}>Doctor Management</Text></View>
      <Text style={styles.placeholder}>Doctor approval and management coming soon...</Text>
    </View>
  );
}
